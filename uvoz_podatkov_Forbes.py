...
# options.add_argument("--headless")                                        # zakomentirano, saj mi drugače ni pravilno bralo strani
...
with open("Obdelani-podatki/output.html", "w", encoding="utf-8") as file: # brez encoding ne dela!
    file.write(str(html))
